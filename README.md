...
```bash
pip install NaaVRE_taskboard_jupyterlab
```
...
# Change directory to the NaaVRE_taskboard_jupyterlab directory
...
folder is located. Then you can remove the symlink named `@naavre/taskboard-jupyterlab` within that folder.
